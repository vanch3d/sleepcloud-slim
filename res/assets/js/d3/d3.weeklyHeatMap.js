...
(function (global, factory) {
     ...
     * Usage:
     *
     *  let chart = d3.chart.weekHeatMap();
    ...
    function weeklyHeatMap() {
        ...
        let chartWidth = 960;
        let chartHeight = 430;
        let chartMargin = { top: 50, right: 0, bottom: 100, left: 30 };
        ...
        function chart(selection) {
            ...
            selection.each(function(data) {
                ...
                let width = chartWidth - chartMargin.left - chartMargin.right,
                ...
                let max = d3.max(data, function (d) {
                    let maxval = d3.max(d.values,function(v){ return v.value; });
                    return maxval;
                });
                ...
                let cards = dayRow.selectAll(".hour")
    ...
    exports.weeklyHeatMap = weeklyHeatMap;
